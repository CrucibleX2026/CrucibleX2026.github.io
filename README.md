...
Real-world audio uses vocal separation and background noise reduction, retaining piano notes and manipulation sounds. The processed audio preserves the timing of the 2× video.
